...
def test_result(cim_cfg_path, op_id, cim_count, axis_align):
    ...
    poly_home = os.environ["POLYCIM_HOME"]
    compiler_cfg_path = os.path.join(
        poly_home, "poly/exp/iccad25/compiler_configs", cim_cfg_path
    )
    pimsim_cfg_path = os.path.join(
        poly_home, "poly/exp/iccad25/pimsim_configs", cim_cfg_path
    )
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        if axis_align:
            cmd.append("--poly-disable-affine")
