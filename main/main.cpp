...
int main(int argc, char **argv) {
  ...
  //       RankedTensorType::Builder({10,10}, builder.getI32Type(),
  //       Attribute()); // builder.getStringAttr("global")
  // RankedTensorType sub_func_ret_type = RankedTensorType::get({10,10},
  // builder.getI32Type(), Attribute()); RankedTensorType sub_func_arg0_type =
  // RankedTensorType::get({10, 10}, builder.getI32Type(), Attribute());
  // RankedTensorType sub_func_arg1_type = RankedTensorType::get({10, 10},
  // builder.getI32Type(), Attribute()); auto sub_func_type =
  // builder.getFunctionType({sub_func_arg0_type, sub_func_arg1_type},
  // {sub_func_ret_type}); std::string sub_func_name = "sub"; auto sub_function
  // = builder.create<func::FuncOp>(loc, sub_func_name, sub_func_type);
  ...
  // mlir::Value c = builder.create<mlir::cim::VVAddOp>(loc, func_arg0,
  // func_arg1); mlir::Value d = builder.create<mlir::cim::VVAddOp>(loc, c,
  // func_arg1); builder.create<func::ReturnOp>(loc, d);
  ...
  mlir::MemRefType return_type =
      mlir::MemRefType::get({10, 10}, builder.getI32Type());
  mlir::MemRefType param_type =
      mlir::MemRefType::get({10, 10}, builder.getI32Type());
  ...
  // mlir::Value _a = builder.create<tensor::EmptyOp>(loc, shape,
  // builder.getI32Type()); mlir::Value _b =
  // builder.create<tensor::EmptyOp>(loc, shape, builder.getI32Type());
  ...
  // func::CallOp call = builder.create<func::CallOp>(loc, sub_function,
  // ValueRange({a, b})); builder.create<func::ReturnOp>(loc,
  // call.getResults());

  mlir::MemRefType type1 =
      mlir::MemRefType::get({10, 10}, builder.getI32Type());
  ...
  mlir::Value _a1 = builder.create<mlir::arith::ConstantOp>(
      loc, builder.getI64IntegerAttr(0));
  mlir::Value _a2 = builder.create<mlir::arith::ConstantOp>(
      loc, builder.getI64IntegerAttr(0));
  ...
  mlir::Value result = builder.create<mlir::memref::SubViewOp>(
      loc, buf1, offsets1, sizes1, strides1);
  ...
  // mlir::Value flatten_buf1 =
  // builder.create<mlir::memref::CollapseShapeOp>(loc, result, reassociation1);
  // mlir::Value _tmp = builder.create<mlir::arith::ConstantOp>(loc,
  // builder.getI64IntegerAttr(4)); FailureOr<Value> _reduce_rank_buf1 =
  // mlir::memref::SubViewOp::rankReduceIfNeeded(builder,
  // loc,result,{mlir::ShapedType::kDynamic}); if (failed(_reduce_rank_buf1)){
  ...
  // mlir::Value flatten_buf2 =
  // builder.create<mlir::memref::CollapseShapeOp>(loc, buf2, reassociation);
  // std::cout << "B" << std::endl;
  builder.create<mlir::cim::CopyOp>(loc, buf2, result);
  // builder.create<func::ReturnOp>(loc, buf3);

  // mlir::Value a3 = builder.create<mlir::arith::ConstantOp>(loc,
  // builder.getI64IntegerAttr(0)); mlir::Value a4 =
  // builder.create<mlir::arith::ConstantOp>(loc, builder.getI64IntegerAttr(0));
  // mlir::Value b3 = builder.create<mlir::arith::ConstantOp>(loc,
  // builder.getI64IntegerAttr(2)); mlir::Value b4 =
  // builder.create<mlir::arith::ConstantOp>(loc, builder.getI64IntegerAttr(2));
  // mlir::Value c3 = builder.create<mlir::arith::ConstantOp>(loc,
  // builder.getI64IntegerAttr(1)); mlir::Value c4 =
  // builder.create<mlir::arith::ConstantOp>(loc, builder.getI64IntegerAttr(1));
  ...
  // mlir::Value result2 = builder.create<mlir::memref::SubViewOp>(loc, result,
  // offsets2, sizes2, strides2);
  theModule.dump();
