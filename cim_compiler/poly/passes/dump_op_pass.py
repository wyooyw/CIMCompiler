...
from cim_compiler.poly.utils.draw import extract_frame_info
...
def dump_schedules(origin_op, new_op, **kwargs):
    ...
    dump_code += f"from cim_compiler.poly.op.base_operator import BasicOperator\n"
    dump_code += f"from cim_compiler.poly.utils.draw import draw, extract_frame_info\n"
    dump_code += f"from cim_compiler.poly.config import CIMConfig\n"
