...
# from cim_compiler.poly.passes.mapping_multiple_macro_pass import mapping_multiple_macro
...
from cim_compiler.poly.utils.dominate import get_non_dominate_iters_of_pw_multi_aff
from cim_compiler.poly.utils.logger import get_logger
from cim_compiler.poly.utils.math import get_factors
...
def mapping_multiple_macro(args, op, cim_cfg, **kwargs):
    ...
    if args.poly_disable_weight_rewrite:
