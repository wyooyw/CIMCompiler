...
from cim_compiler.polycim.utils.utils import get_root, pretty_print_schedule_tree
...
hardware_tile = isl.Map(
    "{ [s0, s1, s2, s3] -> [(s0), (s1), (floor((s2)/4)), (floor((s3)/16)), ((s2) mod 4), ((s3) mod 16)] }"
)
