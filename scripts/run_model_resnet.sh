...
model_path_value_bit_sparse_0_4="${CIM_COMPILER_BASE}/models/resnet_/ResNet_0.4_csd_th2_data_0518"
model_path_value_bit_sparse_0_2="${CIM_COMPILER_BASE}/models/resnet_/ResNet_0.2_csd_th2_data_0620"
quantify="true"


python3 cim_compiler/engine/model_runner.py \
